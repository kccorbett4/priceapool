    ...
    <footer style={{ marginTop: 40, borderTop: `1px solid ${T.border}`, background: T.bg2 }}>
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "32px 16px 24px" }}>
        ...
        <div style={{ borderTop: `1px solid ${T.border}`, paddingTop: 16, fontSize: 10, color: T.textDim, lineHeight: 1.8, textAlign: "center" }}>
          Estimates based on 2026 national averages adjusted for state, metro area, and scope. <Link to="/methodology" style={{ color: T.accent, fontWeight: 600, textDecoration: "none" }}>See full methodology</Link> · <a href="/pool-cost-data.json" style={{ color: T.accent, fontWeight: 600, textDecoration: "none" }}>Open data (JSON</a> / <a href="/pool-cost-data.csv" style={{ color: T.accent, fontWeight: 600, textDecoration: "none" }}>CSV</a>) · <a href="/llms.txt" style={{ color: T.accent, fontWeight: 600, textDecoration: "none" }}>AI / LLM reference</a>. Actual costs vary by contractor, site, soil conditions, and materials. Always get 3+ written bids.<br />
